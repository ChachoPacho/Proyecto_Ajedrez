from tools import img_resizer, ListIMG_PR, ListIMG_SR, data_storage
from tkinter import *
...
class Board:
    ...
    def __init__(self, root):
        #   Creation
        game_zone = ttk.Frame(root.window)
        ...
        self.board_chat['height'] = root.main_frame['width'] - board_size
